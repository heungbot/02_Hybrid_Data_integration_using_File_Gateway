...
[02. 클라이언트 상황 가정 ](#-01-클라이언트-상황-가정-)

[03. 요구사항 정의 ](#-02-요구사항-정의-)

[04. 다이어그램 ](#-03-다이어그램-)

[05. 핵심 서비스 소개 ](#-04-핵심-서비스-소개-)

[06. Interface Endpoint 구현 과정 ](#-05-interface-endpoint-구현-과정-)

[07. Storage Gateway 구현 과정 ](#-06-storage-gateway-구현-과정-)

[08. 테스트 및 결과 ](#-07-테스트-및-결과-)
